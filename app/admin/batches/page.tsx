    ...
    <div className="container mx-auto p-4 py-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Fill in the details below to create a new batch. You will be
            redirected to the admin dashboard where the new batch and its
            registration key will be shown.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
